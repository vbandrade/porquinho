...
void main() {
  group("Test Month operations", () {
    test("adding 1 month on december should increase year", () {
      final startMonth = Month.detailed(12, 2018);
    ...
    test("subtracting 1 month on january should reduce year", () {
      final startMonth = Month.detailed(1, 2018);
    ...
    test("subtracting 13 months should decrease a year and a month", () {
      final startMonth = Month.detailed(10, 2018);
    ...
    test("create using .now() returns current month / year", () {
      ...
      expect(currentMonth.year, DateTime.now().year);
      expect(currentMonth.month, DateTime.now().month);
    });

    test("compare 12/2017 to 01/2018 ", () {
      final dec2017 = Month.detailed(12, 2017);
      final jan2018 = Month.detailed(1, 2018);
    ...
    test("compare 03/2017 to 10/2017 ", () {
      final mar2017 = Month.detailed(3, 2017);
      final oct2017 = Month.detailed(10, 2017);

      expect(mar2017.compareTo(oct2017), -1);
      expect(oct2017.compareTo(mar2017), 1);
    });
    test("compare 06/2017 to 06/2017 ", () {
      final jun2017 = Month.detailed(6, 2017);
      final otherJun2017 = Month.detailed(6, 2017);
